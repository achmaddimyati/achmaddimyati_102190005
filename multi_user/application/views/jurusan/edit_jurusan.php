...
<html lang="en">
    <head>
        ...
        <title>Edit Jurusan</title>   <link rel="canonical" href="https://getbootstrap.com/docs/4.0/examples/sign-in/">
    ...
    <body class="text-center">
                            ...
                            <?php
                                ...
                                <?php endif; ?>
                                    ...
                                    <form class="form-jurusan" action="" method="post">
                                        <div class="card-body">
                                                <input type="hidden" name="id_jurusan" value="<?php echo $jurusan->id_jurusan?>" />   
                                                <label for="jurusan">Nama Jurusan</label>
                                                <input name="nama_jurusan" type="text" id="inputJurusan" class="form-control" placeholder="Nama Jurusan" value="<?php echo $jurusan->nama_jurusan?>" required autofocus>   
